# Demo of Azure Pipelines to integration tests using MySQL with containers
...
- [Define resources in YAML](https://learn.microsoft.com/en-us/azure/devops/pipelines/process/resources?view=azure-devops&tabs=example)
